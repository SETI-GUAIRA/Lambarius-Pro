...
@Repository
public class NotaRepositoryImpl implements NotaQueries {
	...
	@Transactional
	@Override
	public Page<Nota> filtrar(NotaFilter filtro, Pageable pageable) {
		...
		TypedQuery<Nota> typedQuery =  (TypedQuery<Nota>) paginacaoUtil.prepararOrdem(query, root, pageable);
		typedQuery = (TypedQuery<Nota>) paginacaoUtil.prepararIntervalo(typedQuery, pageable);
		
		return new PageImpl<>(typedQuery.getResultList(), pageable, total(filtro));
	}

	private Long total(NotaFilter filtro) {
	...
	private Predicate[] adicionarFiltro(NotaFilter filtro, Root<Nota> root) {
